  ...
  return (
    <Container>
      <div className="w-full overflow-x-hidden">
        ...
        <div className="w-full font-Montserrat">
          <Swiper slidesPerView={3} slidesPerGroup={1} spaceBetween={24}>
            {rooms.map((room, index) => (
              <SwiperSlide key={`room-${index}`}>
                <div className="md:my-10 w-full text-white">
                  <div
                    className="h-[400px] rounded-[8px] relative"
                    style={{
                      background: 'center',
                  ...
                  >
                    ...
                    >
                      <div className="flex px-[28px] pt-[36px]">
                        <div className="">
                          <p className="uppercase text-[28px] truncate text-left">{room.title}</p>
                          <div className="flex justify-between items-center">
                            <p className="text-[28px] text-[#B0985A] truncate">{room.type}</p>
                            <p className="text-[20px] truncate">{room.size}</p>
                          </div>
                        </div>
