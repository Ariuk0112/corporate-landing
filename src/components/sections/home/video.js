...
const Video = () => {
  return (
    <section className="w-full flex flex-col justify-end items-end py-10 md:py-32 gap-2 md:gap-0 overflow-x-hidden">
      <div
        className="w-full h-56 md:h-[530px] md:mr-[230px] rounded flex justify-center items-center"
        style={{
      ...
      <div className="p-5 w-full md:-mt-[230px] bg-[#B0985A] md:h-[430px] md:w-[560px] rounded-lg text-center text-white">
