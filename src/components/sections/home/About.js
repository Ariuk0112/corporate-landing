        ...
        <div className="w-full">
          <div className="grid grid-cols-1 md:hidden gap-5">
            <article className="py-5 md:py-32 text-[14px] md:text-[16px] text[#CACACA] text-justify font-montserrat">
              ...
              first steps into the hotel. The first chain hotels in Mongolia, The Corporate Hotels have four branches.
              Two branches located in a beautiful nature nearby Bogd Mountain provide full opportunities to relax and
              conduct business meetings in a comfortable environment. The branch located in the central zone of the city
              has an event hall and a concert hall that can be transformed from a concert hall into a cinema. A wide
              selection of conference, business meeting, and training rooms with high-speed Internet access is
              available.We also have restaurants that serve Asian and European foods. Coffee lounge, fitness club,
              relaxing massages, swimming pool, sauna, hairdressing services are all located under one roof. Welcome to
              The Corporate Hotels Superior Service and Warm Hospitality
            </article>
            <div className="md:p-16 md:mt-16 min-h-[300px]">
              <Swiper
                effect={'cards'}
                grabCursor={true}
