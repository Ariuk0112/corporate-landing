  ...
  return (
    <div>
      <div className="flex flex-col pt-10 w-full">
        ...
        <p className=" text-black text-[13px] ">Welcome to The Corporate Hotel and Convention Centre</p>
        <article className="py-5 text-black text-[14px] text-opacity-50">
          ...
          lounge where every best of Asian and Western cuisine served. With 92 rooms and suites, The Corporate Hotel and
          Convention Centre is truly one of the finest hotels in perfect location. Its central location and modern
          ...
          like. The hotel is also a home to the one of the outstanding restaurants in Ulaanbaatar. The energetic members
          of our rapidly growing team have a goal to serve you with passion. The warm and comfortable atmosphere will
          make your dining experience rigorously exclusive. Take advantage of our Health Club with indoor pool, fitness
          room, sauna and Jacuzzi. Enjoy and kick back in our stylishly decorated lounge club, or gather with friends
          and family for a delicious meal at Chairman Restaurant. Stay in touch with what matters to you the most with
          high-speed internet access and refresh yourself with a coffee at our coffee Lounge conveniently located in the
          lobby.
        </article>
      </div>
    </div>
